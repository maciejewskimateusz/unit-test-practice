...
class Exercise3Test {
    ...
    private Exercise3 exercise = new Exercise3();
    ...
    public void shouldReturn31Days(String month) {
        ...
        // when
        int dayCount = exercise.getDayCount(yearMonth.getYear(), yearMonth.getMonthValue());
    ...
    @ParameterizedTest
    @CsvSource({"2001, 04", "2001, 06", "2001, 11", "2001, 09"})
    public void shouldReturn30Days(int year, int month) {

        // when
        int dayCount = exercise.getDayCount(year, month);
